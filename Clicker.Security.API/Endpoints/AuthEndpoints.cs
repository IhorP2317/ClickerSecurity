...
public class AuthEndpoints : ICarterModule
{
    ...
    private static async Task<IResult> SignUpAsync(HttpContext httpContext, UserAuthRequestDto userDto)
    {
    ...
    private static async Task<IResult> LoginAsync(HttpContext httpContext, UserAuthRequestDto userDto)
    {
        var authService = httpContext.RequestServices.GetRequiredService<IAuthService>();
