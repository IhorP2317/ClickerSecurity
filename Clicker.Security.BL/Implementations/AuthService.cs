...
public class AuthService:IAuthService
{
    ...
    public async Task<UserPayloadDto> RegisterAsync(UserSignUpRequestDto userSignUpDto, string role = "User") {
 ...
 public async Task<UserAuthResponseDto> LoginAsync(UserLoginRequestDto userDto)
        {
            ...
            var payload = new UserPayloadDto(user.Id, user.TelegramId, user.ReferrerId)
            {
                Role = rolesString
            };
